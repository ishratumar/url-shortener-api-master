...
export default function Advanced() {
    return (
      <>
      <section className="bg-gray-100 pt-32 lg:pb-40">
        ...
        <div className="relative card grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
            ...
            <article className="bg-white p-5 rounded relative">
                <img src={brand} alt="" className="p-3 -mt-12 bg-slate-500 rounded-full" />
            ...
            <article className="bg-white p-5 rounded relative">
                <img src={records} alt="" className="p-3 -mt-12 bg-slate-500 rounded-full" />
            ...
            <article className="bg-white p-5 rounded relative">
                <img src={customizable} alt="" className="p-3 -mt-12 bg-slate-500 rounded-full"/>
